const rolePos1 = ['Goalkeeper', 'Sweeper', 'Defender', 'Defender', 'Defender', 'Midfielder', 'Midfielder', 'Attacker',
    'Attacker', 'Attacker', 'Attacker'];

const rolePos2 = ['Goalkeeper', 'Sweeper', 'Defender', 'Defender', 'Defender', 'Defender', 'Midfielder', 'Midfielder',
    'Attacker', 'Attacker', 'Attacker'];

const rolePos3 = ['Goalkeeper', 'Sweeper', 'Defender', 'Defender', 'Defender', 'Midfielder', 'Midfielder', 'Midfielder',
